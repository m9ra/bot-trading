...
BOOK_DEPTH = 10
TRACKED_PAIRS = ["ADA/CAD", "ADA/ETH", "ADA/EUR", "ADA/USD", "ADA/XBT", "BCH/EUR", "BCH/USD", "BCH/XBT",
                 "DASH/EUR", "DASH/USD", "DASH/XBT", "EOS/ETH", "EOS/EUR", "EOS/USD", "EOS/XBT",
...
SERVER_SUPPORTED_PAIRS = ["XRP/EUR", "XMR/EUR", "ETH/EUR", "REP/EUR", "XBT/EUR", "XLM/EUR"]

# limit the tracked pairs only to those supported by server
TRACKED_PAIRS = SERVER_SUPPORTED_PAIRS
